    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          child: Text('Emergency Service in your City',style: TextStyle(
          ...
          SizedBox(height: 20,),
          Container(alignment: Alignment.center,
          child: Text('Directory',style: TextStyle(
              fontSize: 20,fontWeight: FontWeight.bold
          )),),
          SizedBox(
            height: 20,
              ...
              ListView.builder(
                ...
                itemCount: val.mapEmergency_Search.length,
                  ...
                  if(eList['emergency_services'][index]['msg']=='True'){
                    return ListTile(
                      title: Text(eList['emergency_services'][index]['name'].toString()),
                      subtitle: Text(eList['emergency_services'][index]['city'].toString()),
                      trailing: InkWell(
                        onTap:  () => launch("tel:" + eList['emergency_services'][index]['phone']),
                          child: Icon(Icons.call,color: Colors.blue,)),

                    );
                  }else{
                    return Center(
                      child: Text(eList['emergency_services'][index]['msg'].toString()),
                    );
                  }
